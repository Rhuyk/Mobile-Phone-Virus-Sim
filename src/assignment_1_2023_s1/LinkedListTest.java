...
//        mark += test_function_symmetric();
        ...
        System.out.println("Total mark of Question 1: "+ mark+" out of 50");
    }
    ...
    private static int test_getData(LinkedList linked_list)
    {
        System.out.println("Testing for \"getData\" method");
        int mark = 0;
        if(linked_list.getData(0).compareTo("abc") == 0)
            mark += 2;
        else
            System.out.println("Cannot get data from first node.");
        
        if(linked_list.getData(2).compareTo("123") == 0)
            mark += 2;
        else
...
//    }
    ...
    {
        System.out.println("Testing for \"Queue\" methods");
        int mark = 0;
    ...
    {
        System.out.println("Testing for \"Stack\" methods");
        int mark = 0;
    ...
    {
        System.out.println("Testing: "+testingString);
        int mark = 0;
